...
<table id="#checkoutapipaymentdirect_form" class="table">
    <tr>
      ...
      <tr>
        <td class="field_name"><?php echo JText::_( 'K2STORE_CHECKOUTAPIPAYMENT_CARDHOLDER_NAME' ) ?></td>
        <td>
        <input type="text"
        class="required"
        name="cardname" size="19"
        value="<?php echo !empty($vars->prepop['x_card_name']) ? ($vars->prepop['x_card_name']) : '' ?>"
        title="<?php echo JText::_('K2STORE_CHECKOUTAPIPAYMENT_VALIDATION_ENTER_CARDHOLDER_NAME'); ?>"
         />
    ...
    <tr>
        ...
        title="<?php echo JText::_('K2STORE_CHECKOUTAPIPAYMENT_VALIDATION_ENTER_CREDITCARD'); ?>"
         />
        <div class="k2error"></div>
        </td>
    ...
    <tr>
        ...
        <select name="month" class="required number"
         title="<?php echo JText::_('K2STORE_CHECKOUTAPIPAYMENT_VALIDATION_ENTER_EXPIRY_MONTH'); ?>"
         >
        	<option value=""><?php echo JText::_('K2STORE_MONTH'); ?></option>
        ...
        title="<?php echo JText::_('K2STORE_CHECKOUTAPIPAYMENT_VALIDATION_ENTER_EXPIRY_YEAR'); ?>"
        >
        	<option value=""><?php echo JText::_('K2STORE_YEAR'); ?></option>
        	<?php
    ...
    <tr>
        ...
        title="<?php echo JText::_('K2STORE_CHECKOUTAPIPAYMENT_VALIDATION_ENTER_CARD_CVV'); ?>"
        />
        <div class="k2error"></div>
        </td>
    </tr>

...
namespace Nop.Plugin.Payments.Checkoutapipayment.Validators
{
    public class CreditCardPCIValidator : AbstractValidator<CreditCardPCIModel>
    {
        public CreditCardPCIValidator(ILocalizationService localizationService)
        {
            //useful links:

...
abstract class models_Checkoutapi extends WC_Payment_Gateway implements models_InterfacePayment{
	    ...
	    public function __construct(){
			...
			//define("CHECKOUTAPI_CARDTYPE", serialize ($this ->checkoutapipayment_cardtype));
	    ...
	    private function _init(){
			...
			$this->icon             = apply_filters( 'woocommerce_checkoutapipayment_icon', plugins_url( '../skin/img/checkout-logo@2x.png' , __FILE__ ) );
